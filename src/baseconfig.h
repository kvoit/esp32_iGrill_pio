...
#define MQTT_SERVER              "10.165.40.153"
#define MQTT_SERVERPORT          "1883"
#define MQTT_USERNAME            "esp32-igrill"
#define MQTT_PASSWORD            "Feequae0"
...
#define MQTT_RETAIN_TEMP         true //Set to true if you want the temperature sensor value to be retained in MQTT. (default: false)
